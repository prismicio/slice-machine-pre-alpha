<template>
  <div class="markdown-box-wrapper">
    <div class="markdown-box-header">
      <h4>README.md</h4>
      <Button variant="icon" @click="open(editUrl)">
        <!-- eslint-disable-next-line -->
        <img :src="editIcon" alt="edit on Github" width="18px" />
      </Button>
    </div>
