...
!function (e, t) {
  ...
  function n(e) {
    ...
    function i(e, t, o, s) {
      ...
      (function e(t, o, s, a) {
        ...
        l.rules.length ? r(l.absoluteUrls, {
          onBeforeSend: function onBeforeSend(e, t, r) {
          ...
          onError: function onError(r, n, u) {
            c.push({
              xhr: r,
              url: n
    ...
    s.length ? s.forEach(function (e, t) {
      ...
      if (l) r(s, {
        mimeType: "text/css",
        onBeforeSend: function onBeforeSend(t, r, o) {
          n.onBeforeSend(t, e, r);
        },
        onSuccess: function onSuccess(r, n, a) {
          var c = o(s, location.href);
          i(r, t, e, c);
        },
        onError: function onError(r, o, s) {
        ...
        if (g && s.onlyLegacy) {
          ...
          onComplete: function onComplete(r, n) {
            ...
            if (o.forEach(function (e, t) {
              ...
              }), A = s.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])').length, s.shadowDOM) for (var g, b = [s.rootElement].concat(t(s.rootElement.querySelectorAll("*"))), O = 0; g = b[O]; ++O) {
  ...
  return k.reset = function () {
    for (var e in C = !1, O && (O.disconnect(), O = null), A = 0, x = null, j = !1, w) {
      w[e] = {};
    }
  }, k;
}); // Default values
